...
import { ShoppingCart, HeartHandshake, Package, User } from "lucide-react";
      ...
      <Tabs defaultValue="sales" className="space-y-6">
        ...
        <TabsContent value="sales">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <MetricCard title="Product" value="Inventory | Fulfillment" icon={Package} />
        ...
        <TabsContent value="support">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <MetricCard title="Customer" value="Relations | Success" icon={User} />
            <div className="glass-card p-6 rounded-2xl flex items-center justify-center border border-dashed border-white/10">
